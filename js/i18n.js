...
const i18n = {
    ...
    translations: {
        'ca': {
            ...
            'act_audio_q1': '1. Clica el botó per ARMAR la pista per a la gravació (R).',
        ...
        'es': {
            ...
            'act_audio_q1': '1. Haz clic en el botón para ARMAR la pista para la grabación (R).',
        ...
        'en': {
            ...
            'act_audio_q1': '1. Click the button to ARM the track for recording (R).',
