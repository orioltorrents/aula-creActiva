/*
==========================================================
ACTIVITAT: MAPA DEL MEDITERRANI
...
del mapa del Mediterrani.

Què fa aquest fitxer?
- Inicialitza la partida del mapa
- Carrega el mapa i els països interactius
- Mostra la pregunta actual
- Comprova si el país seleccionat és correcte
- Actualitza la puntuació
- Controla el mode pràctica i el mode examen
- Gestiona el temporitzador si cal
- Mostra feedback i resultat final
- Actualitza els textos si canvia l'idioma

Què NO fa aquest fitxer?
- No controla el menú principal del projecte Mediterrani
...
lògica interna de l'activitat del mapa.
